...
def main(magnification = 2, filter_sz = 1.5):
    ...
    #===========================================================================
    # fibers1 = print_data(read_nii_data("/mnt/data/Professional/UHN/projects/data/minor/gpe2stn_sm_right.nii"), surface_count = 1, colorscale = "Greens", magnification = magnification, filter_sz = filter_sz)
    # fibers2 = print_data(read_nii_data("/mnt/data/Professional/UHN/projects/data/minor/stn2gpe_sm_right.nii"), surface_count = 1, colorscale = "Blues", magnification = magnification, filter_sz = filter_sz)
    #===========================================================================

    fibers1 = print_data(read_nii_data("/mnt/data/Professional/UHN/projects/data/minor/gpe2stn_ass_right.nii"), surface_count = 1, colorscale = "Greens", magnification = magnification, filter_sz = filter_sz)
    fibers2 = print_data(read_nii_data("/mnt/data/Professional/UHN/projects/data/minor/stn2gpe_ass_right.nii"), surface_count = 1, colorscale = "Blues", magnification = magnification, filter_sz = filter_sz)
    ...
    if (scene == 0):
        fig = plotly.graph_objects.Figure(data = [*stn_circles, volume2, volume1, circle1, circle2, circle3, circle4, fibers1, fibers2])
    if (scene == 1):
    ...
    run_in_dash_server(fig, port = 8050 + cam + 100)
